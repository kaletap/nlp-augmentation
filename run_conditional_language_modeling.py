...
"""
# I modified this script for my purposes (Przemysław Kaleta)
...
from src.pipelines.datasets import get_datasets, ConditionalDataset
...
def main(train_size=1000):
    ...
    # It's a little bit of a pain since we are loading from our own Dataset not from file or huggingface/datasets

    config = dataset_configs[data_args.dataset_name]
