...
PARAMS_LIST = [
    [
        ...
        "train",
        [
             # (100, "qa", ("context",), {"type": "no_aug", "repeat": 50}),
             # (1000, "qa", ("context",), {"type": "no_aug", "repeat": 5}),
             # (10, "qa", ("context",), {"type": "rules", "repeat": 50}),
             # (1000, "qa", ("context",), {"type": "rules", "repeat": 5}),
             (100, "qa", ("context",), {"type": "LM", "repeat": 100}),
             (1000, "qa", ("context",), {"type": "LM", "repeat": 10}),
             (5000, "qa", ("context",), {"type": "LM", "repeat": 2}),
        ],
    ],
    # [
    #     "squad_v2",
